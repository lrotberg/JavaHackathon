...
public class APIFlows extends CommonOps {
  ...
  public static void getFlows() { APIActions.getUser("team4"); }
  ...
  public static void putFlows() { APIActions.updateUser(params, "email", "team4edit@gmail.com", 17); }

  @Step("DELETE team4 Method")
  public static void deleteFlows() { APIActions.deleteUser(17); }
}
